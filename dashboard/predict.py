...
"""
TEST_REVIEW = """
It can be good and I love it wow. This is great.
"""
...
def test_model(input_data: str = TEST_REVIEW):
    ...
    if positivity_ratio < 3:
        ...
        score = parsed_text.cats["neg"]
    return {
        "Review text": input_data,
        "Predicted_sentiment": prediction,
        "Negativity": parsed_text.cats["neg"],
        "Positivity": parsed_text.cats["pos"],
    ...
    for label in ["pos", "neg"]:
        ...
        for review in os.listdir(labeled_directory):
            if review.endswith(".txt"):
                ...
                with open(f"{labeled_directory}/{review}", errors='ignore') as f:
                    text = f.read()
